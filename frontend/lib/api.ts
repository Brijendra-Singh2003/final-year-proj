...
export const getAllAppointments = (skip = 0, limit = 50) => api.get("/admin/appointments", { params: { skip, limit } });
export const getAllRecords = (skip = 0, limit = 50) => api.get("/admin/records", { params: { skip, limit } });
